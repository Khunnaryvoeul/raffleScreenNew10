...
public class AdapterClass extends AppCompatActivity implements ShowItemAdapter.ShoeClickedListeners {
    ...
    private void setUpListForMainActivity() {
        ...
        shoeItemList.add(new ShoeItem("New Balance 2002r Protection Pack Purple", "Nike", R.drawable.__ccb10249_2702_4b4f_87d2_de9809363657_540x, 130, releaseDate1, raffleEndDate1, "10:45:00", "10:49:00"));
    ...
    public void onCardClicked(ShoeItem shoe) {
        ...
        Intent intent = new Intent(AdapterClass.this, DetailedActivityShop.class);
